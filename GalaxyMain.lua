...
game.StarterGui:SetCore("ChatMakeSystemMessage",  { Text = "[Dnut] Credits", Color = Color3.fromRGB(0, 255, 0), Font = Enum.Font.Merriweather, FontSize = Enum.FontSize.Size24 } )
